...
public class Programme_10_TubeLine_Advanced {
    public static void main(String[] args) {
        ...
        String station[] = ("Aldgate,Angle,baker street,Bank,Barbican,bayswater,blackfriars,bond street," + "Borough,cannon,street,chancery lane, charing cross,convent gardon,earl's court," +
                "Edgware road,elephant & castle,embankment,euston,euston square," + "Farrington,glocester road,Goodgs street,Great Portland street,green park").split(",");
        ...
        do {
            ...
            String str = JOptionPane.showInputDialog(frame, "Enter station Name A to G ?", "Station Name", JOptionPane.WARNING_MESSAGE);
            String c = "";
            ...
            for (int i = 0; i < station.length; i++) {
                ...
                b = JOptionPane.showInputDialog(frame, "Do you want to try again then please Y", "Press Y Or N", JOptionPane.WARNING_MESSAGE).toLowerCase();
            }
            while (b.equals("Y"));
